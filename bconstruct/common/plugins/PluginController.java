package bconstruct.common.plugins;
...
public class PluginController
{
    ...
    {
        String path = Loader.instance().getConfigDir().toString() + File.separator + "BConstruct.cfg";
        BConstruct.logger.info("[PluginController] Using config path: " + path);
